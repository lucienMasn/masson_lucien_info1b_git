    ...
    if request.method == "POST":
        try:
            if form_add_film.validate_on_submit():
                ...
                strsql_insert_film = """INSERT INTO t_personne (id_personne, nom_pers) VALUES (NULL,%(value_nom_film)s)"""
...
def film_update_wtf():
    ...
    try:
        ...
        if form_update_film.validate_on_submit():
            ...
            str_sql_update_nom_film = """UPDATE t_personne SET nom_pers =%(value_nom_film)s, prenom_pers =%(value_description_film)s WHERE  id_personne=%(value_id_film)s"""
            with DBconnection() as mconn_bd:
            ...
            # afficher et constater que la donnée est mise à jour.s
            ...
            # Opération sur la BD pour récupérer "id_film" et "nom_pers" de la "t_genre"
            ...
            form_update_film.nom_film_update_wtf.data = data_film["nom_pers"]
            #form_update_film.duree_film_update_wtf.data = data_film["prenom_pers"]
            # Debug simple pour contrôler la valeur dans la console "run" de PyCharm
            #print(f" duree film  ", data_film["duree_film"], "  type ", type(data_film["duree_film"]))
            form_update_film.description_film_update_wtf.data = data_film["prenom_pers"]
...
def film_delete_wtf():
    ...
    try:
        ...
        if form_delete_film.submit_btn_del_film.data:
            ...
            str_sql_delete_fk_film_genre = """DELETE FROM t_pers_avoir_licence WHERE fk_personne = %(value_id_film)s"""
